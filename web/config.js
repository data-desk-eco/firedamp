...
mount({
    ...
    about: `<p>Firedamp aggregates satellite methane plume detections from
        ...
        <p>Recent plumes carry provisional attributions generated by the DeepSeek V4 Pro model,
        querying a database of 15 million candidates based on
        ...
        <a href="https://mapstand.com" target="_blank" rel="noopener">MapStand</a>.</p>`,
    search: true,
