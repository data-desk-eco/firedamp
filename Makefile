...
# the store) lives in ~/Tools/etl now; the deployed site reads plumes/data.parquet
# live. this repo only builds and deploys the map.
ETL ?= $(HOME)/Tools/etl
